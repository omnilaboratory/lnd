...
func (PendingChannelsResponse_ForceClosedChannel_AnchorState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{82, 5, 0}
}
...
func (ChannelEventUpdate_UpdateType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{84, 0}
}
...
func (Payment_PaymentStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{126, 0}
}
...
func (HTLCAttempt_HTLCStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{127, 0}
}
...
type ConnectToOBDRequest struct {
	// The OBD node address
...
func (m *ConnectToOBDRequest) Reset()         { *m = ConnectToOBDRequest{} }
func (m *ConnectToOBDRequest) String() string { return proto.CompactTextString(m) }
func (*ConnectToOBDRequest) ProtoMessage()    {}
func (*ConnectToOBDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{0}
}

func (m *ConnectToOBDRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ConnectToOBDRequest.Unmarshal(m, b)
}
func (m *ConnectToOBDRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ConnectToOBDRequest.Marshal(b, m, deterministic)
}
func (m *ConnectToOBDRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConnectToOBDRequest.Merge(m, src)
}
func (m *ConnectToOBDRequest) XXX_Size() int {
	return xxx_messageInfo_ConnectToOBDRequest.Size(m)
}
func (m *ConnectToOBDRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ConnectToOBDRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ConnectToOBDRequest proto.InternalMessageInfo

func (m *ConnectToOBDRequest) GetNodeAddress() string {
	if m != nil {
...
type ConnectToOBDResponse struct {
	// The response for connection succeeded or failed.
...
func (m *ConnectToOBDResponse) Reset()         { *m = ConnectToOBDResponse{} }
func (m *ConnectToOBDResponse) String() string { return proto.CompactTextString(m) }
func (*ConnectToOBDResponse) ProtoMessage()    {}
func (*ConnectToOBDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{1}
}

func (m *ConnectToOBDResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ConnectToOBDResponse.Unmarshal(m, b)
}
func (m *ConnectToOBDResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ConnectToOBDResponse.Marshal(b, m, deterministic)
}
func (m *ConnectToOBDResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConnectToOBDResponse.Merge(m, src)
}
func (m *ConnectToOBDResponse) XXX_Size() int {
	return xxx_messageInfo_ConnectToOBDResponse.Size(m)
}
func (m *ConnectToOBDResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ConnectToOBDResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ConnectToOBDResponse proto.InternalMessageInfo

func (m *ConnectToOBDResponse) GetResp() string {
	if m != nil {
		return m.Resp
	}
	return ""
...
type ObdLoginRequest struct {
	// The mnemonic words
	MnemonicWords        string   `protobuf:"bytes,1,opt,name=mnemonic_words,json=mnemonicWords,proto3" json:"mnemonic_words,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ObdLoginRequest) Reset()         { *m = ObdLoginRequest{} }
func (m *ObdLoginRequest) String() string { return proto.CompactTextString(m) }
func (*ObdLoginRequest) ProtoMessage()    {}
func (*ObdLoginRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{2}
}

func (m *ObdLoginRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObdLoginRequest.Unmarshal(m, b)
}
func (m *ObdLoginRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObdLoginRequest.Marshal(b, m, deterministic)
}
func (m *ObdLoginRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObdLoginRequest.Merge(m, src)
}
func (m *ObdLoginRequest) XXX_Size() int {
	return xxx_messageInfo_ObdLoginRequest.Size(m)
}
func (m *ObdLoginRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ObdLoginRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ObdLoginRequest proto.InternalMessageInfo

func (m *ObdLoginRequest) GetMnemonicWords() string {
	if m != nil {
		return m.MnemonicWords
	}
	return ""
}

type ObdLoginResponse struct {
	// The response for login succeeded or failed.
	Resp                 string   `protobuf:"bytes,1,opt,name=resp,proto3" json:"resp,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *ObdLoginResponse) Reset()         { *m = ObdLoginResponse{} }
func (m *ObdLoginResponse) String() string { return proto.CompactTextString(m) }
func (*ObdLoginResponse) ProtoMessage()    {}
func (*ObdLoginResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{3}
}

func (m *ObdLoginResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObdLoginResponse.Unmarshal(m, b)
}
func (m *ObdLoginResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObdLoginResponse.Marshal(b, m, deterministic)
}
func (m *ObdLoginResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObdLoginResponse.Merge(m, src)
}
func (m *ObdLoginResponse) XXX_Size() int {
	return xxx_messageInfo_ObdLoginResponse.Size(m)
}
func (m *ObdLoginResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ObdLoginResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ObdLoginResponse proto.InternalMessageInfo

func (m *ObdLoginResponse) GetResp() string {
	if m != nil {
		return m.Resp
	}
	return ""
...
type OpenChannelInfo struct {
	FundingPubKey        string   `protobuf:"bytes,1,opt,name=FundingPubKey,proto3" json:"FundingPubKey,omitempty"`
	FunderAddressIndex   int32    `protobuf:"varint,2,opt,name=FunderAddressIndex,proto3" json:"FunderAddressIndex,omitempty"`
...
func (m *OpenChannelInfo) Reset()         { *m = OpenChannelInfo{} }
func (m *OpenChannelInfo) String() string { return proto.CompactTextString(m) }
func (*OpenChannelInfo) ProtoMessage()    {}
func (*OpenChannelInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{4}
}

func (m *OpenChannelInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OpenChannelInfo.Unmarshal(m, b)
}
func (m *OpenChannelInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OpenChannelInfo.Marshal(b, m, deterministic)
}
func (m *OpenChannelInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OpenChannelInfo.Merge(m, src)
}
func (m *OpenChannelInfo) XXX_Size() int {
	return xxx_messageInfo_OpenChannelInfo.Size(m)
}
func (m *OpenChannelInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_OpenChannelInfo.DiscardUnknown(m)
}

var xxx_messageInfo_OpenChannelInfo proto.InternalMessageInfo

func (m *OpenChannelInfo) GetFundingPubKey() string {
	if m != nil {
		return m.FundingPubKey
	}
	return ""
}

func (m *OpenChannelInfo) GetFunderAddressIndex() int32 {
	if m != nil {
		return m.FunderAddressIndex
	}
	return 0
}

func (m *OpenChannelInfo) GetIsPrivate() bool {
	if m != nil {
		return m.IsPrivate
	}
	return false
...
type ObdOpenChannelRequest struct {
	NodeId               string           `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	UserId               string           `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	Info                 *OpenChannelInfo `protobuf:"bytes,3,opt,name=info,proto3" json:"info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *ObdOpenChannelRequest) Reset()         { *m = ObdOpenChannelRequest{} }
func (m *ObdOpenChannelRequest) String() string { return proto.CompactTextString(m) }
func (*ObdOpenChannelRequest) ProtoMessage()    {}
func (*ObdOpenChannelRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{5}
}

func (m *ObdOpenChannelRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObdOpenChannelRequest.Unmarshal(m, b)
}
func (m *ObdOpenChannelRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObdOpenChannelRequest.Marshal(b, m, deterministic)
}
func (m *ObdOpenChannelRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObdOpenChannelRequest.Merge(m, src)
}
func (m *ObdOpenChannelRequest) XXX_Size() int {
	return xxx_messageInfo_ObdOpenChannelRequest.Size(m)
}
func (m *ObdOpenChannelRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ObdOpenChannelRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ObdOpenChannelRequest proto.InternalMessageInfo

func (m *ObdOpenChannelRequest) GetNodeId() string {
	if m != nil {
		return m.NodeId
	}
	return ""
...
func (m *ObdOpenChannelRequest) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func (m *ObdOpenChannelRequest) GetInfo() *OpenChannelInfo {
	if m != nil {
		return m.Info
	}
	return nil
...
type ObdOpenChannelResponse struct {
	Resp                 string   `protobuf:"bytes,1,opt,name=resp,proto3" json:"resp,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *ObdOpenChannelResponse) Reset()         { *m = ObdOpenChannelResponse{} }
func (m *ObdOpenChannelResponse) String() string { return proto.CompactTextString(m) }
func (*ObdOpenChannelResponse) ProtoMessage()    {}
func (*ObdOpenChannelResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{6}
}

func (m *ObdOpenChannelResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObdOpenChannelResponse.Unmarshal(m, b)
}
func (m *ObdOpenChannelResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObdOpenChannelResponse.Marshal(b, m, deterministic)
}
func (m *ObdOpenChannelResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObdOpenChannelResponse.Merge(m, src)
}
func (m *ObdOpenChannelResponse) XXX_Size() int {
	return xxx_messageInfo_ObdOpenChannelResponse.Size(m)
}
func (m *ObdOpenChannelResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ObdOpenChannelResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ObdOpenChannelResponse proto.InternalMessageInfo

func (m *ObdOpenChannelResponse) GetResp() string {
	if m != nil {
		return m.Resp
	}
	return ""
...
type AcceptChannelInfo struct {
	TemporaryChannelId   string   `protobuf:"bytes,1,opt,name=TemporaryChannelId,proto3" json:"TemporaryChannelId,omitempty"`
	FundingPubKey        string   `protobuf:"bytes,2,opt,name=FundingPubKey,proto3" json:"FundingPubKey,omitempty"`
	FundeeAddressIndex   int32    `protobuf:"varint,3,opt,name=FundeeAddressIndex,proto3" json:"FundeeAddressIndex,omitempty"`
	Approval             bool     `protobuf:"varint,4,opt,name=Approval,proto3" json:"Approval,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *AcceptChannelInfo) Reset()         { *m = AcceptChannelInfo{} }
func (m *AcceptChannelInfo) String() string { return proto.CompactTextString(m) }
func (*AcceptChannelInfo) ProtoMessage()    {}
func (*AcceptChannelInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{7}
}

func (m *AcceptChannelInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AcceptChannelInfo.Unmarshal(m, b)
}
func (m *AcceptChannelInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AcceptChannelInfo.Marshal(b, m, deterministic)
}
func (m *AcceptChannelInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AcceptChannelInfo.Merge(m, src)
}
func (m *AcceptChannelInfo) XXX_Size() int {
	return xxx_messageInfo_AcceptChannelInfo.Size(m)
}
func (m *AcceptChannelInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_AcceptChannelInfo.DiscardUnknown(m)
}

var xxx_messageInfo_AcceptChannelInfo proto.InternalMessageInfo

func (m *AcceptChannelInfo) GetTemporaryChannelId() string {
	if m != nil {
...
func (m *AcceptChannelInfo) GetFundingPubKey() string {
	if m != nil {
		return m.FundingPubKey
	}
	return ""
...
func (m *AcceptChannelInfo) GetFundeeAddressIndex() int32 {
	if m != nil {
		return m.FundeeAddressIndex
	}
	return 0
}

func (m *AcceptChannelInfo) GetApproval() bool {
	if m != nil {
		return m.Approval
	}
	return false
...
type ObdAcceptChannelRequest struct {
	NodeId               string             `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	UserId               string             `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	Info                 *AcceptChannelInfo `protobuf:"bytes,3,opt,name=info,proto3" json:"info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *ObdAcceptChannelRequest) Reset()         { *m = ObdAcceptChannelRequest{} }
func (m *ObdAcceptChannelRequest) String() string { return proto.CompactTextString(m) }
func (*ObdAcceptChannelRequest) ProtoMessage()    {}
func (*ObdAcceptChannelRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{8}
}

func (m *ObdAcceptChannelRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObdAcceptChannelRequest.Unmarshal(m, b)
}
func (m *ObdAcceptChannelRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObdAcceptChannelRequest.Marshal(b, m, deterministic)
}
func (m *ObdAcceptChannelRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObdAcceptChannelRequest.Merge(m, src)
}
func (m *ObdAcceptChannelRequest) XXX_Size() int {
	return xxx_messageInfo_ObdAcceptChannelRequest.Size(m)
}
func (m *ObdAcceptChannelRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ObdAcceptChannelRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ObdAcceptChannelRequest proto.InternalMessageInfo

func (m *ObdAcceptChannelRequest) GetNodeId() string {
	if m != nil {
		return m.NodeId
	}
	return ""
...
func (m *ObdAcceptChannelRequest) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func (m *ObdAcceptChannelRequest) GetInfo() *AcceptChannelInfo {
	if m != nil {
		return m.Info
	}
	return nil
...
type ObdAcceptChannelResponse struct {
	Resp                 string   `protobuf:"bytes,1,opt,name=resp,proto3" json:"resp,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *ObdAcceptChannelResponse) Reset()         { *m = ObdAcceptChannelResponse{} }
func (m *ObdAcceptChannelResponse) String() string { return proto.CompactTextString(m) }
func (*ObdAcceptChannelResponse) ProtoMessage()    {}
func (*ObdAcceptChannelResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{9}
}

func (m *ObdAcceptChannelResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObdAcceptChannelResponse.Unmarshal(m, b)
}
func (m *ObdAcceptChannelResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObdAcceptChannelResponse.Marshal(b, m, deterministic)
}
func (m *ObdAcceptChannelResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObdAcceptChannelResponse.Merge(m, src)
}
func (m *ObdAcceptChannelResponse) XXX_Size() int {
	return xxx_messageInfo_ObdAcceptChannelResponse.Size(m)
}
func (m *ObdAcceptChannelResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ObdAcceptChannelResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ObdAcceptChannelResponse proto.InternalMessageInfo

func (m *ObdAcceptChannelResponse) GetResp() string {
	if m != nil {
		return m.Resp
	}
	return ""
...
func (*PendingChannelsResponse_PendingChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{82, 0}
}
...
func (*PendingChannelsResponse_PendingOpenChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{82, 1}
}
...
func (*PendingChannelsResponse_WaitingCloseChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{82, 2}
}
...
func (*PendingChannelsResponse_Commitments) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{82, 3}
}
...
func (*PendingChannelsResponse_ClosedChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{82, 4}
}
...
func (*PendingChannelsResponse_ForceClosedChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{82, 5}
}
...
func init() {
	...
	proto.RegisterType((*ConnectToOBDRequest)(nil), "lnrpc.ConnectToOBDRequest")
	proto.RegisterType((*ConnectToOBDResponse)(nil), "lnrpc.ConnectToOBDResponse")
	proto.RegisterType((*ObdLoginRequest)(nil), "lnrpc.ObdLoginRequest")
	proto.RegisterType((*ObdLoginResponse)(nil), "lnrpc.ObdLoginResponse")
	proto.RegisterType((*OpenChannelInfo)(nil), "lnrpc.OpenChannelInfo")
	proto.RegisterType((*ObdOpenChannelRequest)(nil), "lnrpc.ObdOpenChannelRequest")
	proto.RegisterType((*ObdOpenChannelResponse)(nil), "lnrpc.ObdOpenChannelResponse")
	proto.RegisterType((*AcceptChannelInfo)(nil), "lnrpc.AcceptChannelInfo")
	proto.RegisterType((*ObdAcceptChannelRequest)(nil), "lnrpc.ObdAcceptChannelRequest")
	proto.RegisterType((*ObdAcceptChannelResponse)(nil), "lnrpc.ObdAcceptChannelResponse")
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	,
}
...
type LightningClient interface {
	...
	ConnectToOBD(ctx context.Context, in *ConnectToOBDRequest, opts ...grpc.CallOption) (*ConnectToOBDResponse, error)
	// lncli: `obdlogin`
	//ObdLogin login to OBD.
	ObdLogin(ctx context.Context, in *ObdLoginRequest, opts ...grpc.CallOption) (*ObdLoginResponse, error)
	// lncli: `obdopenchannel`
	//OpenChannel launch a request to create a channel with someone else(Bob).
	ObdOpenChannel(ctx context.Context, in *ObdOpenChannelRequest, opts ...grpc.CallOption) (*ObdOpenChannelResponse, error)
	// lncli: `obdacceptchannel`
	//AcceptChannel counterparty replies to OpenChannel.
	ObdAcceptChannel(ctx context.Context, in *ObdAcceptChannelRequest, opts ...grpc.CallOption) (*ObdAcceptChannelResponse, error)
}
...
func (c *lightningClient) ConnectToOBD(ctx context.Context, in *ConnectToOBDRequest, opts ...grpc.CallOption) (*ConnectToOBDResponse, error) {
	out := new(ConnectToOBDResponse)
	err := c.cc.Invoke(ctx, "/lnrpc.Lightning/ConnectToOBD", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) ObdLogin(ctx context.Context, in *ObdLoginRequest, opts ...grpc.CallOption) (*ObdLoginResponse, error) {
	out := new(ObdLoginResponse)
	err := c.cc.Invoke(ctx, "/lnrpc.Lightning/ObdLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) ObdOpenChannel(ctx context.Context, in *ObdOpenChannelRequest, opts ...grpc.CallOption) (*ObdOpenChannelResponse, error) {
	out := new(ObdOpenChannelResponse)
	err := c.cc.Invoke(ctx, "/lnrpc.Lightning/ObdOpenChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) ObdAcceptChannel(ctx context.Context, in *ObdAcceptChannelRequest, opts ...grpc.CallOption) (*ObdAcceptChannelResponse, error) {
	out := new(ObdAcceptChannelResponse)
	err := c.cc.Invoke(ctx, "/lnrpc.Lightning/ObdAcceptChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LightningServer interface {
	...
	// lncli: `connectToOBD`
	//ConnectToOBD connect to an OmniBOL Daemon (OBD).
	ConnectToOBD(context.Context, *ConnectToOBDRequest) (*ConnectToOBDResponse, error)
	// lncli: `obdlogin`
	//ObdLogin login to OBD.
	ObdLogin(context.Context, *ObdLoginRequest) (*ObdLoginResponse, error)
	// lncli: `obdopenchannel`
	//OpenChannel launch a request to create a channel with someone else(Bob).
	ObdOpenChannel(context.Context, *ObdOpenChannelRequest) (*ObdOpenChannelResponse, error)
	// lncli: `obdacceptchannel`
	//AcceptChannel counterparty replies to OpenChannel.
	ObdAcceptChannel(context.Context, *ObdAcceptChannelRequest) (*ObdAcceptChannelResponse, error)
}
...
func (*UnimplementedLightningServer) ConnectToOBD(ctx context.Context, req *ConnectToOBDRequest) (*ConnectToOBDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConnectToOBD not implemented")
}
func (*UnimplementedLightningServer) ObdLogin(ctx context.Context, req *ObdLoginRequest) (*ObdLoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ObdLogin not implemented")
}
func (*UnimplementedLightningServer) ObdOpenChannel(ctx context.Context, req *ObdOpenChannelRequest) (*ObdOpenChannelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ObdOpenChannel not implemented")
}
func (*UnimplementedLightningServer) ObdAcceptChannel(ctx context.Context, req *ObdAcceptChannelRequest) (*ObdAcceptChannelResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ObdAcceptChannel not implemented")
}
...
func _Lightning_ConnectToOBD_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConnectToOBDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).ConnectToOBD(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/ConnectToOBD",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).ConnectToOBD(ctx, req.(*ConnectToOBDRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lightning_ObdLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ObdLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).ObdLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/ObdLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).ObdLogin(ctx, req.(*ObdLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lightning_ObdOpenChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ObdOpenChannelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).ObdOpenChannel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/ObdOpenChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).ObdOpenChannel(ctx, req.(*ObdOpenChannelRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lightning_ObdAcceptChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ObdAcceptChannelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).ObdAcceptChannel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/ObdAcceptChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).ObdAcceptChannel(ctx, req.(*ObdAcceptChannelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ConnectToOBD",
			Handler:    _Lightning_ConnectToOBD_Handler,
		},
		{
			MethodName: "ObdLogin",
			Handler:    _Lightning_ObdLogin_Handler,
		},
		{
			MethodName: "ObdOpenChannel",
			Handler:    _Lightning_ObdOpenChannel_Handler,
		},
		{
			MethodName: "ObdAcceptChannel",
			Handler:    _Lightning_ObdAcceptChannel_Handler,
		},
	},
